...
--
-- Host: localhost    Database: promo_db
-- ------------------------------------------------------
...
CREATE TABLE `promo_logs` (
  ...
  CONSTRAINT `promo_logs_ibfk_1` FOREIGN KEY (`promocode_id`) REFERENCES `promocodes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `promo_logs`
--

LOCK TABLES `promo_logs` WRITE;
/*!40000 ALTER TABLE `promo_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `promo_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-08 14:26:22
